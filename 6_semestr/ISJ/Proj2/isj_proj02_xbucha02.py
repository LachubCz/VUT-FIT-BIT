...
def second_task():
    ...
    in_both_eskymo_prepos = set(prepos).intersection(eskymo)    # vase reseni
    # test
...
def third_task():
    ...
    wordfreq_eskymo = {'do':'2', 'pre':'1', 'du':'4', 'za':'1'}  # vase reseni
    # test
...
def fourth_task():
    ...
    backward_except_last = ('u dubu tu budu.'[:-1])[::-1]  # vase reseni
    # test
...
def fifth_task():
    ...
    skip2_str = ', '.join(str(x) for x in skip2)  # vase reseni
    # test
