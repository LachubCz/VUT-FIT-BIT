...
*/
	...
	{
		s->top = -1;  //vrchol je nastaveny na -1, protoze se zacina prvkem na nulte pozici
	}
}
...
*/
	...
	return (s->top < 0);  //vraci 1 pokud je vyraz pravda
}
...
*/
	...
	return (s->top == (STACK_SIZE - 1));  //vraci 1 pokud je vyraz pravda; -1 je zde protoze se zacina na prvku nula a ne na prvku s indexem 1
}
...
*/
	...
	{
	  *c = s->arr[s->top];  //pres ukazatel predava funkce posledni znak na zasobniku
	}
}
...
*/
	...
	{
		s->top = s->top - 1;  //posune vrchol zasobniku o jedna, prvek neodstranuje
	}
}
...
*/
	...
	{
		s->top = s->top + 1;  //posune zasobnik o jedna
		s->arr[s->top] = c;  //vlozi znak na vrchol zasobniku
	}
}
