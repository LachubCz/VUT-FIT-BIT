...
class QNetwork():
    ...
    def __init__(self, h_size):
        ...
        #print("self.actions_onehot: {}" .format(self.actions_onehot))
    ...
    while j < max_episode_length:
        ...
        if total_steps > pre_train_steps:
            ...
            if total_steps % update_freq == 0:
                ...
                actor_network.model.fit([this_state, actions], [np.zeros((32, 1, 1, 4)) ,target_q], verbose=0)
