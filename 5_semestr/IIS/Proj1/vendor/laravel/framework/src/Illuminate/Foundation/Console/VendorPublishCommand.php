...
class VendorPublishCommand extends Command
{
    ...
    protected $signature = 'vendor:publish {--force : Overwrite any existing files.}
                    {--all : Publish images for all service providers without prompt.}
                    {--provider= : The service provider that has images you want to publish.}
                    {--tag=* : One or many tags that have images you want to publish.}';
     ...
     * @var string
     */
    protected $description = 'Publish any publishable images from vendor packages';
    ...
    /**
     * Publishes the images for a tag.
     *
     * @param  string  $tag
     * @return mixed
     */
