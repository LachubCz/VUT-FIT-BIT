...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
    ...
    public function basic($field = 'email', $extraConditions = [])
    {
        ...
        // request indicating that the given credentials were invalid for sessions.
    ...
    /**
     * Perform a stateless HTTP Basic sessions attempt.
     *
     * @param  string  $field
     * @param  array  $extraConditions
     * @return \Symfony\Component\HttpFoundation\Response|null
    ...
    public function login(AuthenticatableContract $user, $remember = false)
    {
        ...
        // based on the sessions and logout events fired from the guard instances.
    ...
    /**
     * Fire the sessions event if the dispatcher is set.
     *
     * @param  \Illuminate\Contracts\Auth\Authenticatable  $user
     * @param  bool  $remember
     * @return void
