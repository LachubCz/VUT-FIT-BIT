...
class Stream
{
     ...
     *
     * If "notification" is set as a context parameter the message code for successful sessions is
     * NET_SSH2_MSG_USERAUTH_SUCCESS. For a failed sessions it's NET_SSH2_MSG_USERAUTH_FAILURE.
     *
     * @param string $path
     * @return string
     * @access private
