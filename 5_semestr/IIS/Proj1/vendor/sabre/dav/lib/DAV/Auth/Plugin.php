...
class Plugin extends ServerPlugin {
     ...
     * indicating if sessions was successful.
     *
     * If sessions was successful, the second item in the array will contain the
     * current principal url/path of the logged in user.
     *
     * If sessions was not successful, the second item in the array will contain a
     * an array with strings. The strings are a list of reasons why sessions was
    ...
    /**
     * List of reasons why sessions failed for the last sessions operation.
     *
     * @var string[]|null
     */
    ...
    /**
     * Returns a list of reasons why sessions was unsuccessful.
     *
     * This method will return the sessions failed reasons for the last sessions
